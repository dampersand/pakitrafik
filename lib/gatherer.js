...
const gatherer = {
	...
	//send a query to the plugin, exactly as written.  Gatherer should receive an object that includes the value of the query and the time at which the value was gathered.
	//returns the promise from plugin.query.
	...
	//send multiple queries to the plugin for all link values in a map object.  Returns a promise when complete.
	getMapValues(map) {
